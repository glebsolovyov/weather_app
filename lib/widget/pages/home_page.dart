                                        ...
                                        child: Column(children: [
                                          ...
                                          Padding(
                                            ...
                                            child: SizedBox(
                                              height: 30,
                                              width: 30,
                                              child: getIcon(hourylyData[index]
                                                  .description),
                                            ),
                                          ),
                                          HourlyTemperature(
                                              data:
                                                  ("${hourylyData[0].temp.toString()}°")),
                                        ]),
                                      ),
                                    ),
                                  ),
                                              ...
                                              SizedBox(
                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    Text(
                                                        "${daylyData[index].averageTemp.toString()}°")
                                                  ],
                                                ),
                                              ),
                                              getIcon(daylyData[index]
                                                  .description
                                                  .toString()),
                                              SizedBox(
                                                width: 40,
